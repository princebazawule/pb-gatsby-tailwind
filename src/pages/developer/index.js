...
export default function Developer({ data }) {
  ...
  const openLink = () => {
    ...
    return (
        <>
            <Layout>
              <Seo title="Developer" keywords={[`frontend`, `react`, `vue`, `javascript`, `gatsby`]} description={`Prince Bazawule - Developer, creating fast responsive UIs and rich web experiences for over 15 years`} image={`${siteUrl}${defaultImageSrc}`} url={`${siteUrl}/developer/`} />
