...
export default function Dj({ data }) {
  ...
  return (
    <>
      <Layout>
        <Seo title="Prince Bazawule - DJ" keywords={[`music`, `mixes`, `playlist`, `mixcloud`, `soundcloud`, `spotify`]} description={`Prince Bazawule - Music lover, curator and DJ`} image={`${siteUrl}${defaultImageSrc}`} url={`${siteUrl}/dj/`} />
