...
export default function Contact({ data }) {
  ...
  return (
    <>
      <Layout>
        <Seo title="Connect" keywords={[`connect`, `contact`, `social`, `social links`, `links`]} description={`Prince Bazawule - Connect with me on social media, request a collaboration, explore my music and shop my designs`} image={`${siteUrl}${defaultImageSrc}`} url={`${siteUrl}/contact/`} />
