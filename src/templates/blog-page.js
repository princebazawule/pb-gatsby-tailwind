...
const BlogIndex = ( { pageContext } ) => {
  ...
  return (
    <Layout>
      <Seo title="Prince Bazawule - Blog" keywords={[`tips`, `tutorials`, `resources`, `freebies`]} description={`Prince Bazawule - Collection of my articles, tutorials, tips and resources. Check back regularly`} image={`${siteUrl}${defaultImageSrc}`} url={`${siteUrl}/blog/`} />
