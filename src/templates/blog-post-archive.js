...
const ArchiveIndex = ( { pageContext } ) => {
  ...
  return (
    <Layout>
      <Seo title="Blog | Prince Bazawule" keywords={[`tips`, `tutorials`, `resources`, `freebies`]} description={`Prince Bazawule - Collection of my articles, tutorials, tips and resources. Check back regularly`} image={`${siteUrl}${defaultImageSrc}`} url={location.href} />
