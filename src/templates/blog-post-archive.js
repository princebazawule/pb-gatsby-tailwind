    ...
    <Layout>
      ...
      >
        ...
        <div className="blog-wrap mt-16 relative">
          <div className={`blog-filter lg:absolute right-0 lg:w-3/12 ${isFirstPage ? '' : 'relative left-0 right-0 w-full mb-20' }`}>
                    ...
                    <Link to={`/post${post.uri}`} itemProp="url">
                      ...
                      >
                          ...
                          <div className={`flex flex-row flex-nowrap justify-start items-start w-full xl:w-3/4 relative ${isFirstPage ? 'group-first-of-type:flex-wrap xl:group-first-of-type:pl-60 group-first-of-type:flex-col xl:group-first-of-type:w-4/5' : '' }`}>
                              ...
                              <div className={`excerpt hidden ${isFirstPage ? 'group-first-of-type:block group-first-of-type:text-lg' : '' }`} dangerouslySetInnerHTML={{ __html: post.excerpt}}></div>
                          </div>
